// Generated by Qleany v1.7.3 from entity_controller.tera

use super::{
    dtos::{CreateTableCellDto, TableCellDto, UpdateTableCellDto},
    units_of_work::{TableCellReadUoWFactory, TableCellWriteUoWFactory},
};
use crate::TableCellRelationshipDto;
...
pub fn create_orphan(
    ...
    stack_id: Option<u64>,
    entity: &CreateTableCellDto,
) -> Result<TableCellDto> {
    let uow_factory = TableCellWriteUoWFactory::new(db_context, event_hub);
    let mut uc = use_cases::UndoableCreateOrphanUseCase::new(uow_factory);
    let entity_in: common::entities::TableCell = entity.into();
...
pub fn create_orphan_multi(
    ...
    undo_redo_manager: &mut UndoRedoManager,
    stack_id: Option<u64>,
    entities: &[CreateTableCellDto],
) -> Result<Vec<TableCellDto>> {
    let uow_factory = TableCellWriteUoWFactory::new(db_context, event_hub);
    let entities_in: Vec<common::entities::TableCell> =
...
pub fn get(db_context: &DbContext, id: &EntityId) -> Result<Option<TableCellDto>> {
    let uow_factory = TableCellReadUoWFactory::new(db_context);
    let uc = use_cases::GetUseCase::new(uow_factory);
    Ok(uc.execute(id)?.map(|e| e.into()))
}

pub fn get_all(db_context: &DbContext) -> Result<Vec<TableCellDto>> {
    let uow_factory = TableCellReadUoWFactory::new(db_context);
    let uc = use_cases::GetUseCase::new(uow_factory);
    Ok(uc.execute_all()?.into_iter().map(|e| e.into()).collect())
}

pub fn get_multi(db_context: &DbContext, ids: &[EntityId]) -> Result<Vec<Option<TableCellDto>>> {
    let uow_factory = TableCellReadUoWFactory::new(db_context);
    let uc = use_cases::GetUseCase::new(uow_factory);
    Ok(uc
        .execute_multi(ids)?
...
pub fn get_relationship(
    ...
    let uow_factory = TableCellReadUoWFactory::new(db_context);
    let uc = use_cases::GetRelationshipUseCase::<TableCellRelationshipField, _>::new(uow_factory);
    uc.execute(id, field)
}
...
pub fn get_relationship_many(
    ...
    let uow_factory = TableCellReadUoWFactory::new(db_context);
    let uc =
        use_cases::GetRelationshipManyUseCase::<TableCellRelationshipField, _>::new(uow_factory);
...
pub fn get_relationship_count(
    ...
    let uow_factory = TableCellReadUoWFactory::new(db_context);
    let uc =
        use_cases::GetRelationshipCountUseCase::<TableCellRelationshipField, _>::new(uow_factory);
    uc.execute(id, field)
}
...
pub fn get_relationship_in_range(
    ...
    let uow_factory = TableCellReadUoWFactory::new(db_context);
    let uc =
        use_cases::GetRelationshipInRangeUseCase::<TableCellRelationshipField, _>::new(uow_factory);
...
pub fn set_relationship(
    ...
    let uow_factory = TableCellWriteUoWFactory::new(db_context, event_hub);
    let mut uc = use_cases::UndoableSetRelationshipUseCase::<TableCellRelationshipField, _>::new(
        uow_factory,
    );
...
pub fn move_relationship(
    ...
    let uow_factory = TableCellWriteUoWFactory::new(db_context, event_hub);
    let mut uc = use_cases::UndoableMoveRelationshipUseCase::<TableCellRelationshipField, _>::new(
        uow_factory,
    );
...
mod tests {
    ...
    use crate::table::dtos::CreateTableDto;
    use crate::table::table_controller;
    ...
    fn create_one(ctx: &mut TestContext) -> TableCellDto {
        create_orphan(
            &ctx.db,
            &ctx.hub,
            &mut ctx.undo,
            None,
            &CreateTableCellDto::default(),
        )
        .unwrap()
    }
    ...
    fn test_update() {
        let mut ctx = TestContext::new();
        let created = create_one(&mut ctx);
        let update_dto: UpdateTableCellDto = created.into();
    ...
    fn test_get_relationship_default() {
        ...
        let created = create_one(&mut ctx);
        let rel_ids =
            get_relationship(&ctx.db, &created.id, &TableCellRelationshipField::CellFrame).unwrap();
    ...
    fn test_get_relationship_count_default() {
        ...
        let created = create_one(&mut ctx);
        let count =
            get_relationship_count(&ctx.db, &created.id, &TableCellRelationshipField::CellFrame)
                .unwrap();
        assert_eq!(count, 0);
    }
}
