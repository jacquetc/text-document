...
pub struct TableCellRepository<'a> {
    redb_table: Box<dyn TableCellTable + 'a>,
    transaction: &'a Transaction,
}

impl<'a> TableCellRepository<'a> {
    pub fn new(redb_table: Box<dyn TableCellTable + 'a>, transaction: &'a Transaction) -> Self {
        TableCellRepository {
            redb_table,
            transaction,
        }
    ...
    pub fn restore(
        ...
        // TableCell: Created + Updated (has CellFrame relationship)
...
pub struct TableCellRepositoryRO<'a> {
    redb_table: Box<dyn TableCellTableRO + 'a>,
}
impl<'a> TableCellRepositoryRO<'a> {
    pub fn new(redb_table: Box<dyn TableCellTableRO + 'a>) -> Self {
        TableCellRepositoryRO { redb_table }
    }
    pub fn get(&self, id: &EntityId) -> Result<Option<TableCell>, RepositoryError> {
        self.redb_table.get(id)
    }
