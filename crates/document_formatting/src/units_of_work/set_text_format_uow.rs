...
use crate::use_cases::set_text_format_uc::{
    SetTextFormatUnitOfWorkFactoryTrait, SetTextFormatUnitOfWorkTrait,
};
...
// Unit of work for SetTextFormat

pub struct SetTextFormatUnitOfWork {
    context: DbContext,
...
impl SetTextFormatUnitOfWork {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        SetTextFormatUnitOfWork {
...
impl CommandUnitOfWork for SetTextFormatUnitOfWork {
...
impl SetTextFormatUnitOfWorkFactory {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        SetTextFormatUnitOfWorkFactory {
            context: db_context.clone(),
            event_hub: event_hub.clone(),
        }
    }
...
impl SetTextFormatUnitOfWorkFactoryTrait for SetTextFormatUnitOfWorkFactory {
    fn create(&self) -> Box<dyn SetTextFormatUnitOfWorkTrait> {
        Box::new(SetTextFormatUnitOfWork::new(&self.context, &self.event_hub))
    }
}
