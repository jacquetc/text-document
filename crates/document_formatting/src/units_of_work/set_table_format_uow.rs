...
use crate::use_cases::set_table_format_uc::{
    SetTableFormatUnitOfWorkFactoryTrait, SetTableFormatUnitOfWorkTrait,
};
...
// Unit of work for SetTableFormat

pub struct SetTableFormatUnitOfWork {
    context: DbContext,
...
impl SetTableFormatUnitOfWork {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        SetTableFormatUnitOfWork {
...
impl CommandUnitOfWork for SetTableFormatUnitOfWork {
...
impl SetTableFormatUnitOfWorkTrait for SetTableFormatUnitOfWork {}

pub struct SetTableFormatUnitOfWorkFactory {
    context: DbContext,
    event_hub: Arc<EventHub>,
}

impl SetTableFormatUnitOfWorkFactory {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        SetTableFormatUnitOfWorkFactory {
            context: db_context.clone(),
            event_hub: event_hub.clone(),
        }
    }
...
impl SetTableFormatUnitOfWorkFactoryTrait for SetTableFormatUnitOfWorkFactory {
    fn create(&self) -> Box<dyn SetTableFormatUnitOfWorkTrait> {
        Box::new(SetTableFormatUnitOfWork::new(
            &self.context,
            &self.event_hub,
        ))
    }
