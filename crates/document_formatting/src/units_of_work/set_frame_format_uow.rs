...
use crate::use_cases::set_frame_format_uc::{
    SetFrameFormatUnitOfWorkFactoryTrait, SetFrameFormatUnitOfWorkTrait,
};
...
// Unit of work for SetFrameFormat

pub struct SetFrameFormatUnitOfWork {
    context: DbContext,
...
impl SetFrameFormatUnitOfWork {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        SetFrameFormatUnitOfWork {
...
impl CommandUnitOfWork for SetFrameFormatUnitOfWork {
...
impl SetFrameFormatUnitOfWorkFactory {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        SetFrameFormatUnitOfWorkFactory {
            context: db_context.clone(),
            event_hub: event_hub.clone(),
        }
    }
...
impl SetFrameFormatUnitOfWorkFactoryTrait for SetFrameFormatUnitOfWorkFactory {
    fn create(&self) -> Box<dyn SetFrameFormatUnitOfWorkTrait> {
        Box::new(SetFrameFormatUnitOfWork::new(
            &self.context,
            &self.event_hub,
        ))
    }
