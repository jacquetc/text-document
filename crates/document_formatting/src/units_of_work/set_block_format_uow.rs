...
use crate::use_cases::set_block_format_uc::{
    SetBlockFormatUnitOfWorkFactoryTrait, SetBlockFormatUnitOfWorkTrait,
};
...
// Unit of work for SetBlockFormat

pub struct SetBlockFormatUnitOfWork {
    context: DbContext,
...
impl SetBlockFormatUnitOfWork {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        SetBlockFormatUnitOfWork {
...
impl CommandUnitOfWork for SetBlockFormatUnitOfWork {
...
//
// Exactly the same macros must be set in the use case uow trait file in ../use_cases/set_block_format_uc.rs
//
...
impl SetBlockFormatUnitOfWorkTrait for SetBlockFormatUnitOfWork {}

pub struct SetBlockFormatUnitOfWorkFactory {
    context: DbContext,
    event_hub: Arc<EventHub>,
}

impl SetBlockFormatUnitOfWorkFactory {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        SetBlockFormatUnitOfWorkFactory {
            context: db_context.clone(),
            event_hub: event_hub.clone(),
        }
    }
...
impl SetBlockFormatUnitOfWorkFactoryTrait for SetBlockFormatUnitOfWorkFactory {
    fn create(&self) -> Box<dyn SetBlockFormatUnitOfWorkTrait> {
        Box::new(SetBlockFormatUnitOfWork::new(
            &self.context,
            &self.event_hub,
        ))
    }
