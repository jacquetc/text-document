...
fn test_merge_text_format_preserves_other_fields() -> Result<()> {
    ...
    document_formatting_controller::set_text_format(
        ...
        &SetTextFormatDto {
            ...
            letter_spacing: 5,
            word_spacing: 10,
            underline_style: UnderlineStyle::WaveUnderline,
            vertical_alignment: CharVerticalAlignment::SuperScript,
        },
    )?;
