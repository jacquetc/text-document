...
//
// Exactly the same macros must be set in the use case uow trait file in ../units_of_work/insert_fragment_uow.rs
//
...
impl InsertFragmentUseCase {
    pub fn new(uow_factory: Box<dyn InsertFragmentUnitOfWorkFactoryTrait>) -> Self {
        InsertFragmentUseCase { uow_factory }
    }
    ...
    pub fn execute(&mut self, dto: &InsertFragmentDto) -> Result<InsertFragmentResultDto> {
        ...
        //TODO: InsertFragmentUseCase to be implemented
        unimplemented!("InsertFragmentUseCase unimplemented");
        uow.commit()?;
        //Ok(InsertFragmentResultDto {
        //
        //})
...
impl UndoRedoCommand for InsertFragmentUseCase {
    fn undo(&mut self) -> Result<()> {
        //TODO: InsertFragmentUseCase  undo to be implemented
        unimplemented!("InsertFragmentUseCase undo unimplemented");

        Ok(())
    }

    fn redo(&mut self) -> Result<()> {
        //TODO: InsertFragmentUseCase  redo to be implemented
        unimplemented!("InsertFragmentUseCase redo unimplemented");
