...
//
// Exactly the same macros must be set in the use case uow trait file in ../units_of_work/insert_markdown_at_position_uow.rs
//
...
impl InsertMarkdownAtPositionUseCase {
    pub fn new(uow_factory: Box<dyn InsertMarkdownAtPositionUnitOfWorkFactoryTrait>) -> Self {
        InsertMarkdownAtPositionUseCase { uow_factory }
    }
    ...
    pub fn execute(
        ...
        //TODO: InsertMarkdownAtPositionUseCase to be implemented
        unimplemented!("InsertMarkdownAtPositionUseCase unimplemented");
        uow.commit()?;
        //Ok(InsertMarkdownAtPositionResultDto {
        //
        //})
...
impl UndoRedoCommand for InsertMarkdownAtPositionUseCase {
    fn undo(&mut self) -> Result<()> {
        //TODO: InsertMarkdownAtPositionUseCase  undo to be implemented
        unimplemented!("InsertMarkdownAtPositionUseCase undo unimplemented");

        Ok(())
    }

    fn redo(&mut self) -> Result<()> {
        //TODO: InsertMarkdownAtPositionUseCase  redo to be implemented
        unimplemented!("InsertMarkdownAtPositionUseCase redo unimplemented");
