...
//
// Exactly the same macros must be set in the use case uow trait file in ../units_of_work/delete_text_uow.rs
//
...
impl DeleteTextUseCase {
    ...
    pub fn execute(&mut self, dto: &DeleteTextDto) -> Result<DeleteTextResultDto> {
        ...
        //TODO: DeleteTextUseCase to be implemented
        unimplemented!("DeleteTextUseCase unimplemented");
        uow.commit()?;
        //Ok(DeleteTextResultDto {
        //
        //})
...
impl UndoRedoCommand for DeleteTextUseCase {
    fn undo(&mut self) -> Result<()> {
        //TODO: DeleteTextUseCase  undo to be implemented
        unimplemented!("DeleteTextUseCase undo unimplemented");

        Ok(())
    }

    fn redo(&mut self) -> Result<()> {
        //TODO: DeleteTextUseCase  redo to be implemented
        unimplemented!("DeleteTextUseCase redo unimplemented");
