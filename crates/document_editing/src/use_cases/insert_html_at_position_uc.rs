...
//
// Exactly the same macros must be set in the use case uow trait file in ../units_of_work/insert_html_at_position_uow.rs
//
...
impl InsertHtmlAtPositionUseCase {
    pub fn new(uow_factory: Box<dyn InsertHtmlAtPositionUnitOfWorkFactoryTrait>) -> Self {
        InsertHtmlAtPositionUseCase { uow_factory }
    }
    ...
    pub fn execute(
        ...
        //TODO: InsertHtmlAtPositionUseCase to be implemented
        unimplemented!("InsertHtmlAtPositionUseCase unimplemented");
        uow.commit()?;
        //Ok(InsertHtmlAtPositionResultDto {
        //
        //})
...
impl UndoRedoCommand for InsertHtmlAtPositionUseCase {
    fn undo(&mut self) -> Result<()> {
        //TODO: InsertHtmlAtPositionUseCase  undo to be implemented
        unimplemented!("InsertHtmlAtPositionUseCase undo unimplemented");

        Ok(())
    }

    fn redo(&mut self) -> Result<()> {
        //TODO: InsertHtmlAtPositionUseCase  redo to be implemented
        unimplemented!("InsertHtmlAtPositionUseCase redo unimplemented");
