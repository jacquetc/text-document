...
use crate::use_cases::remove_table_uc::{
    RemoveTableUnitOfWorkFactoryTrait, RemoveTableUnitOfWorkTrait,
};
...
// Unit of work for RemoveTable

pub struct RemoveTableUnitOfWork {
    context: DbContext,
...
impl RemoveTableUnitOfWork {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        RemoveTableUnitOfWork {
...
impl CommandUnitOfWork for RemoveTableUnitOfWork {
...
// Macros must match exactly those in remove_table_uc.rs
...
impl RemoveTableUnitOfWorkTrait for RemoveTableUnitOfWork {}

pub struct RemoveTableUnitOfWorkFactory {
    context: DbContext,
    event_hub: Arc<EventHub>,
}

impl RemoveTableUnitOfWorkFactory {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        RemoveTableUnitOfWorkFactory {
            context: db_context.clone(),
            event_hub: event_hub.clone(),
        }
    }
...
impl RemoveTableUnitOfWorkFactoryTrait for RemoveTableUnitOfWorkFactory {
    fn create(&self) -> Box<dyn RemoveTableUnitOfWorkTrait> {
        Box::new(RemoveTableUnitOfWork::new(&self.context, &self.event_hub))
    }
}
