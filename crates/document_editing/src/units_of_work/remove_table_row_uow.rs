...
use crate::use_cases::remove_table_row_uc::{
    RemoveTableRowUnitOfWorkFactoryTrait, RemoveTableRowUnitOfWorkTrait,
};
...
// Unit of work for RemoveTableRow

pub struct RemoveTableRowUnitOfWork {
    context: DbContext,
...
impl RemoveTableRowUnitOfWork {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        RemoveTableRowUnitOfWork {
...
impl CommandUnitOfWork for RemoveTableRowUnitOfWork {
...
impl RemoveTableRowUnitOfWorkTrait for RemoveTableRowUnitOfWork {}

pub struct RemoveTableRowUnitOfWorkFactory {
    context: DbContext,
    event_hub: Arc<EventHub>,
}

impl RemoveTableRowUnitOfWorkFactory {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        RemoveTableRowUnitOfWorkFactory {
            context: db_context.clone(),
            event_hub: event_hub.clone(),
        }
    }
...
impl RemoveTableRowUnitOfWorkFactoryTrait for RemoveTableRowUnitOfWorkFactory {
    fn create(&self) -> Box<dyn RemoveTableRowUnitOfWorkTrait> {
        Box::new(RemoveTableRowUnitOfWork::new(
            &self.context,
            &self.event_hub,
        ))
    }
