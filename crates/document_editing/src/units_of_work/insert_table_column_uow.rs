...
use crate::use_cases::insert_table_column_uc::{
    InsertTableColumnUnitOfWorkFactoryTrait, InsertTableColumnUnitOfWorkTrait,
};
...
// Unit of work for InsertTableColumn

pub struct InsertTableColumnUnitOfWork {
    context: DbContext,
...
impl InsertTableColumnUnitOfWork {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        InsertTableColumnUnitOfWork {
...
impl CommandUnitOfWork for InsertTableColumnUnitOfWork {
...
impl InsertTableColumnUnitOfWorkTrait for InsertTableColumnUnitOfWork {}

pub struct InsertTableColumnUnitOfWorkFactory {
    context: DbContext,
    event_hub: Arc<EventHub>,
}

impl InsertTableColumnUnitOfWorkFactory {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        InsertTableColumnUnitOfWorkFactory {
            context: db_context.clone(),
            event_hub: event_hub.clone(),
        }
    }
...
impl InsertTableColumnUnitOfWorkFactoryTrait for InsertTableColumnUnitOfWorkFactory {
    fn create(&self) -> Box<dyn InsertTableColumnUnitOfWorkTrait> {
        Box::new(InsertTableColumnUnitOfWork::new(
            &self.context,
            &self.event_hub,
        ))
    }
