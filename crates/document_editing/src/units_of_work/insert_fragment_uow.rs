...
use crate::use_cases::insert_fragment_uc::{
    InsertFragmentUnitOfWorkFactoryTrait, InsertFragmentUnitOfWorkTrait,
};
...
// Unit of work for InsertFragment

pub struct InsertFragmentUnitOfWork {
    context: DbContext,
...
impl InsertFragmentUnitOfWork {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        InsertFragmentUnitOfWork {
...
impl CommandUnitOfWork for InsertFragmentUnitOfWork {
...
//
// Exactly the same macros must be set in the use case uow trait file in ../use_cases/insert_fragment_uc.rs
//
...
impl InsertFragmentUnitOfWorkFactory {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        InsertFragmentUnitOfWorkFactory {
            context: db_context.clone(),
            event_hub: event_hub.clone(),
        }
    }
...
impl InsertFragmentUnitOfWorkFactoryTrait for InsertFragmentUnitOfWorkFactory {
    fn create(&self) -> Box<dyn InsertFragmentUnitOfWorkTrait> {
        Box::new(InsertFragmentUnitOfWork::new(
            &self.context,
            &self.event_hub,
        ))
    }
