...
use crate::use_cases::insert_table_row_uc::{
    InsertTableRowUnitOfWorkFactoryTrait, InsertTableRowUnitOfWorkTrait,
};
...
// Unit of work for InsertTableRow

pub struct InsertTableRowUnitOfWork {
    context: DbContext,
...
impl InsertTableRowUnitOfWork {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        InsertTableRowUnitOfWork {
...
impl CommandUnitOfWork for InsertTableRowUnitOfWork {
...
impl InsertTableRowUnitOfWorkTrait for InsertTableRowUnitOfWork {}

pub struct InsertTableRowUnitOfWorkFactory {
    context: DbContext,
    event_hub: Arc<EventHub>,
}

impl InsertTableRowUnitOfWorkFactory {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        InsertTableRowUnitOfWorkFactory {
            context: db_context.clone(),
            event_hub: event_hub.clone(),
        }
    }
...
impl InsertTableRowUnitOfWorkFactoryTrait for InsertTableRowUnitOfWorkFactory {
    fn create(&self) -> Box<dyn InsertTableRowUnitOfWorkTrait> {
        Box::new(InsertTableRowUnitOfWork::new(
            &self.context,
            &self.event_hub,
        ))
    }
