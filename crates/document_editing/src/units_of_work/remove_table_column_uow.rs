...
use crate::use_cases::remove_table_column_uc::{
    RemoveTableColumnUnitOfWorkFactoryTrait, RemoveTableColumnUnitOfWorkTrait,
};
...
// Unit of work for RemoveTableColumn

pub struct RemoveTableColumnUnitOfWork {
    context: DbContext,
...
impl RemoveTableColumnUnitOfWork {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        RemoveTableColumnUnitOfWork {
...
impl CommandUnitOfWork for RemoveTableColumnUnitOfWork {
...
impl RemoveTableColumnUnitOfWorkTrait for RemoveTableColumnUnitOfWork {}

pub struct RemoveTableColumnUnitOfWorkFactory {
    context: DbContext,
    event_hub: Arc<EventHub>,
}

impl RemoveTableColumnUnitOfWorkFactory {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        RemoveTableColumnUnitOfWorkFactory {
            context: db_context.clone(),
            event_hub: event_hub.clone(),
        }
    }
...
impl RemoveTableColumnUnitOfWorkFactoryTrait for RemoveTableColumnUnitOfWorkFactory {
    fn create(&self) -> Box<dyn RemoveTableColumnUnitOfWorkTrait> {
        Box::new(RemoveTableColumnUnitOfWork::new(
            &self.context,
            &self.event_hub,
        ))
    }
