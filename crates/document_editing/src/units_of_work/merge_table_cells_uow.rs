...
use crate::use_cases::merge_table_cells_uc::{
    MergeTableCellsUnitOfWorkFactoryTrait, MergeTableCellsUnitOfWorkTrait,
};
...
// Unit of work for MergeTableCells

pub struct MergeTableCellsUnitOfWork {
    context: DbContext,
...
impl MergeTableCellsUnitOfWork {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        MergeTableCellsUnitOfWork {
...
impl CommandUnitOfWork for MergeTableCellsUnitOfWork {
...
impl MergeTableCellsUnitOfWorkTrait for MergeTableCellsUnitOfWork {}

pub struct MergeTableCellsUnitOfWorkFactory {
    context: DbContext,
    event_hub: Arc<EventHub>,
}

impl MergeTableCellsUnitOfWorkFactory {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        MergeTableCellsUnitOfWorkFactory {
            context: db_context.clone(),
            event_hub: event_hub.clone(),
        }
    }
...
impl MergeTableCellsUnitOfWorkFactoryTrait for MergeTableCellsUnitOfWorkFactory {
    fn create(&self) -> Box<dyn MergeTableCellsUnitOfWorkTrait> {
        Box::new(MergeTableCellsUnitOfWork::new(
            &self.context,
            &self.event_hub,
        ))
    }
